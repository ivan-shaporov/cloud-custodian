...
class CostFilterTest(BaseTest):
    ...
    def test_cost_filter_schema_validate(self):
        p = self.load_policy({
    ...
    def test_exact_cost(self):
        ...
        expected_cost = 0.378524  # might change in the new cassette, replace as necessary
        ...
        self.assertEqual(resources[0]['c7n:cost']['PreTaxCost'], expected_cost)

    def test_timeframe_days(self):

        expected_cost = 1.373439  # might change in the new cassette, replace as necessary
